...
public class Camera extends Device {
  ...
  protected static long swigRelease(Camera obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Camera(String name) {
    this(wrapperJNI.new_Camera__SWIG_0(name), true);
  }

  public Camera(int tag) {
    this(wrapperJNI.new_Camera__SWIG_1(tag), true);
  }
