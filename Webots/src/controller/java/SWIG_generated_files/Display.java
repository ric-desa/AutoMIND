...
public class Display extends Device {
  ...
  protected static long swigRelease(Display obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Display(String name) {
    this(wrapperJNI.new_Display__SWIG_0(name), true);
  }

  public Display(int tag) {
    this(wrapperJNI.new_Display__SWIG_1(tag), true);
  }
