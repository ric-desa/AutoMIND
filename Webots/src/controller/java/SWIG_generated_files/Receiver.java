...
public class Receiver extends Device {
  ...
  protected static long swigRelease(Receiver obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Receiver(String name) {
    this(wrapperJNI.new_Receiver__SWIG_0(name), true);
  }

  public Receiver(int tag) {
    this(wrapperJNI.new_Receiver__SWIG_1(tag), true);
  }
