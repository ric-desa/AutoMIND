...
public class Speaker extends Device {
  ...
  protected static long swigRelease(Speaker obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Speaker(String name) {
    this(wrapperJNI.new_Speaker__SWIG_0(name), true);
  }

  public Speaker(int tag) {
    this(wrapperJNI.new_Speaker__SWIG_1(tag), true);
  }
