...
public class Supervisor extends Robot {
  ...
  protected static long swigRelease(Supervisor obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public static Supervisor getSupervisorInstance() {
    long cPtr = wrapperJNI.Supervisor_getSupervisorInstance();
    return (cPtr == 0) ? null : new Supervisor(cPtr, false);
  }
  ...
  public void setLabel(int id, String label, double xpos, double ypos, double size, int color) {
    wrapperJNI.Supervisor_setLabel__SWIG_2(swigCPtr, this, id, label, xpos, ypos, size, color);
  }
